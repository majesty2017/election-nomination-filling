...
use App\Http\Controllers\NominationFillingController;
...
Route::get('/student-register', [RegisterStudentController::class, 'showRegistrationForm'])->name('student-register');
Route::post('/student-register', [RegisterStudentController::class, 'register'])->name('student.register');
...
Route::get('/home', [DashboardController::class,'dashboardAnalytics'])->name('home');
...
Route::group(['prefix' => 'dashboard'], function () {
  Route::get('home', [DashboardController::class,'dashboardAnalytics'])->name('dashboard-analytics');
  Route::post('/create', [DashboardController::class,'store'])->name('filling.create');
  Route::post('/filling', [DashboardController::class,'filling'])->name('filling.show');
  Route::post('/count-filling', [DashboardController::class,'count_fillings'])->name('filling.count');
  Route::post('/count-payment', [DashboardController::class,'count_payments'])->name('payment.count');
});
/* Route Dashboards */
...
Route::group(['prefix' => 'users'], function () {
  ...
  Route::get('user-lists', [UserController::class,'users'])->name('user-lists');
...
Route::group(['prefix' => 'departments'], function () {
  ...
  Route::get('department-lists', [DepartmentController::class,'departments'])->name('department-lists');
  Route::post('create', [DepartmentController::class,'store'])->name('department-create');
  Route::post('show', [DepartmentController::class,'show'])->name('department-show');
...
Route::group(['prefix' => 'programmes'], function () {
  Route::get('', [ProgrammeController::class,'index'])->name('programmes');
  Route::get('programme-lists', [ProgrammeController::class,'programmes'])->name('programme-lists');
  Route::post('create', [ProgrammeController::class,'store'])->name('programme-create');
  Route::post('show', [ProgrammeController::class,'show'])->name('programme-show');
  Route::post('update', [ProgrammeController::class,'update'])->name('programme-update');
  Route::delete('destroy/{id}', [ProgrammeController::class,'destroy'])->name('programme-destroy');
});
/* Route Programmes */
...
Route::group(['prefix' => 'portfolios'], function () {
  ...
  Route::get('portfolio-lists', [PortfolioController::class,'portfolios'])->name('portfolio-lists');
  Route::post('create', [PortfolioController::class,'store'])->name('portfolio-create');
  Route::post('show', [PortfolioController::class,'show'])->name('portfolio-show');
  Route::post('update', [PortfolioController::class,'update'])->name('portfolio-update');
  Route::delete('destroy/{id}', [PortfolioController::class,'destroy'])->name('portfolio-destroy');
});
/* Route Portfolios */
...
Route::group(['prefix' => 'students'], function () {
  ...
  Route::get('student-lists', [StudentController::class,'students'])->name('student-lists');
  Route::post('create', [StudentController::class,'store'])->name('student-create');
  Route::post('show', [StudentController::class,'show'])->name('student-show');
...
Route::group(['prefix' => 'payments'], function () {
  ...
  Route::get('payment-lists', [PaymentController::class,'payments'])->name('payment-lists');
  Route::get('payment-lists', [PaymentController::class,'payments'])->name('payment-lists');
  Route::post('applicant-lists', [PaymentController::class,'applicants'])->name('applicant-lists');
  Route::post('portfolio-lists', [PaymentController::class,'portfolios'])->name('portfolio-lists');
  Route::post('portfolio', [PaymentController::class,'portfolio'])->name('portfolio');
  Route::post('create', [PaymentController::class,'store'])->name('payment-create');
  Route::post('show', [PaymentController::class,'show'])->name('payment-show');
...
// Laravel 8
    Route::post('/pay', [PaymentController::class, 'redirectToGateway'])->name('pay');// Laravel 8
    Route::get('/payment/callback', [PaymentController::class, 'handleGatewayCallback']);
});
/* Route Payments */

/* Route  Nomination Fillings*/
Route::group(['prefix' => 'fillings'], function () {
  Route::get('', [NominationFillingController::class,'index'])->name('fillings');
  Route::get('filling-lists', [NominationFillingController::class,'fillings'])->name('filling-lists');
    Route::post('programmes', [NominationFillingController::class,'programmes'])->name('programmes');
    Route::post('departments', [NominationFillingController::class,'departments'])->name('programmes');
  Route::post('create', [NominationFillingController::class,'store'])->name('filling-create');
  Route::post('show', [NominationFillingController::class,'show'])->name('filling-show');
  Route::post('update', [NominationFillingController::class,'update'])->name('filling-update');
  Route::post('destroy', [NominationFillingController::class,'destroy'])->name('filling-destroy');
});
/* Route Nomination Fillings */
