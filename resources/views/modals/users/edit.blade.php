                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="tel"
                                       class="form-control" name="phone" id="e_phone" maxlength="12" min="10" placeholder="">
                            </div>
                        </div>
                        <input type="hidden" name="is_admin" id="e_is_admin" value="1">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="email">Email</label>
                                <input type="email"
                                       class="form-control" name="email" id="e_email" placeholder="">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="password"
                                       class="form-control" name="password" id="ep_password" aria-describedby="helpId" placeholder="">
                                <small id="helpId" class="form-text text-warning">Keep password field empty if you won't change it.</small>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="ep_password_confirmation">Re-Type Password</label>
                                <input type="password"
                                       class="form-control" name="password_confirmation" id="ep_password_confirmation" placeholder="">
                            </div>
                        </div>
                    </div>
