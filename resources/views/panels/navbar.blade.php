  ...
  <div class="navbar-header d-xl-block d-none">
    <ul class="nav navbar-nav">
      <li class="nav-item">
        ...
        <h2 class="brand-text mb-0">Filling System</h2>
        </a>
      </li>
    </ul>
  </div>
    ...
    <div class="navbar-container d-flex content">
        <div class="bookmark-wrapper d-flex align-items-center">
          ...
          <ul class="nav navbar-nav bookmark-icons">
            <li class="nav-item d-none d-lg-block hidden"><a class="nav-link" href="{{url('app/calendar')}}" data-toggle="tooltip" data-placement="top" title="Calendar"><i class="ficon" data-feather="calendar"></i></a></li>
            <li class="nav-item d-none d-lg-block hidden"><a class="nav-link" href="{{url('app/todo')}}" data-toggle="tooltip" data-placement="top" title="Todo"><i class="ficon" data-feather="check-square"></i></a></li>
          </ul>
        </div>
        ...
        <li class="nav-item dropdown dropdown-user">
          <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <div class="user-nav d-sm-flex d-none">
              ...
              <span class="user-status">@if(auth()->user()->is_admin === 1) Admin @else Applicant @endif</span>
            </div>
            <span class="avatar">
              <img class="round" src="{{asset('images/profile/user-uploads/'.auth()->user()->image)}}" alt="avatar" height="40" width="40">
