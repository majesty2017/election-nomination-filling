            ...
            <div class="row" data-aos="fade-up" data-aos-delay="100">
                <div class="col-lg-12 d-flex justify-content-center">
                    <ul id="portfolio-flters">
                        ...
                        <li data-filter=".filter-app">Presidency</li>
                        <li data-filter=".filter-card">General Secretary</li>
                        <li data-filter=".filter-web">Finance Officer</li>
                        <li data-filter=".filter-web">Women Commissioner</li>
                        <li data-filter=".filter-web">GNUTS Local Rep</li>
